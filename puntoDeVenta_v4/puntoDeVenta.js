calcularValorTotal = function () {
    ...
    let porcentajeDescuento = recuperarDescuento("txtPorcentajeDescuento");

    //variables para almacenar los retornos de las funciones
    let valorSubtotal = calcularSubTotal("txtPrecio","txtCantidad");
    let valorDescuento = calcularValorDescuento(valorSubtotal,"txtPorcentajeDescuento");
...
limpiar = function () {
    /*
        ...
        Si funciona, hacer un commit
     */
    nombreProducto = textoEnCaja("txtProducto","")
    precioProducto = textoEnCaja("txtCantidad","")
    cantidad = textoEnCaja("txtPrecio","")
    porcentajeDescuento = textoEnCaja("txtPorcentajeDescuento","")

    valorSubtotal = subTextos("lblSubtotal","0.0")
    valorDescuento = subTextos("lblDescuento","0.0")
    valorIVA = subTextos("lblValorIVA","0.0")
    valorTotal = subTextos("lblTotal","0.0")
